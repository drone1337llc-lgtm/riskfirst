...
# Exact expected figure verified live: 131 = 60 cryptobot + 71 options.
...
if [ "$COUNT" != "131" ]; then
  echo "WARNING: canonical count is $COUNT, docs claim 131 -- re-sweep needed"
  exit 1
fi
echo "count sweep clean: 131 everywhere"
