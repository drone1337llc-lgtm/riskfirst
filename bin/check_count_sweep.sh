...
# Exact expected figure verified live: 128 = 57 cryptobot + 71 options.
...
if [ "$COUNT" != "128" ]; then
  echo "WARNING: canonical count is $COUNT, docs claim 128 -- re-sweep needed"
  exit 1
fi
echo "count sweep clean: 128 everywhere"
