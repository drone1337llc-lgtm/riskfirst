...
Alpaca paper API. Full guardrail suite: `python -m pytest` (89 tests: 27 cryptobot + 62 options — incl. Greeks, risk arbiter, MCP contract, LLM referee, and the paper-loop runner).
