...
Alpaca paper API. Full guardrail suite: `python -m pytest` (107 tests: 36 cryptobot + 71 options — incl. Greeks, risk arbiter, MCP contract, LLM referee, and the paper-loop runner).
