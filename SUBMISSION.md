...
Alpaca paper API. Full guardrail suite: `python -m pytest` (87 tests: 27 cryptobot + 60 options — incl. Greeks, risk arbiter, MCP contract, LLM referee, and the paper-loop runner).
