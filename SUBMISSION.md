...
Alpaca paper API. Full guardrail suite: `python -m pytest` (93 tests: 27 cryptobot + 66 options — incl. Greeks, risk arbiter, MCP contract, LLM referee, and the paper-loop runner).
