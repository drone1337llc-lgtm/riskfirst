...
- [x] **Slide deck** — `slides/index.html` (10 slides, RiskFirst-branded, 93-test + OOS-gate honest numbers)
...
- [x] **93 offline tests pass** (verified: 27 cryptobot + 66 options incl. MCP contract, LLM referee, runner) ✓
