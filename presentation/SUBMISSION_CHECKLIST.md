...
- [x] **Slide deck** — `slides/index.html` (10 slides, RiskFirst-branded, 92-test + OOS-gate honest numbers)
...
- [x] **92 offline tests pass** (verified: 27 cryptobot + 65 options incl. MCP contract, LLM referee, runner) ✓
