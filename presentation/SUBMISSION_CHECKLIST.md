...
- [x] **Slide deck** — `slides/index.html` (10 slides, RiskFirst-branded, 107-test + OOS-gate honest numbers)
...
- [x] **107 offline tests pass** (verified: 36 cryptobot + 71 options incl. MCP contract, LLM referee, runner) ✓
