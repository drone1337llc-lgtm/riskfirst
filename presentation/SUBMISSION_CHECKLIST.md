...
- [x] **Slide deck** — `slides/index.html` (10 slides, RiskFirst-branded, 131-test + OOS-gate honest numbers)
...
- [x] **131 offline tests pass** (verified: 59 cryptobot + 71 options incl. MCP contract, LLM referee, runner) ✓
