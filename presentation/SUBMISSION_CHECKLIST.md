...
- [x] **Slide deck** — `slides/index.html` (10 slides, RiskFirst-branded, 90-test + OOS-gate honest numbers)
...
- [x] **90 offline tests pass** (verified: 27 cryptobot + 63 options incl. MCP contract, LLM referee, runner) ✓
