...
- [x] **Slide deck** — `slides/index.html` (10 slides, RiskFirst-branded, 98-test + OOS-gate honest numbers)
...
- [x] **98 offline tests pass** (verified: 27 cryptobot + 71 options incl. MCP contract, LLM referee, runner) ✓
