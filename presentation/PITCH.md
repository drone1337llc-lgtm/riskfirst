...
- **Fully offline-tested** against a deterministic mock client — **140 passing tests** (Greeks, parity, IV recovery, 2% sizing, drawdown blocks, spread/OI screens, MCP contract, LLM referee, paper-loop runner). Zero keys needed.
...
- **140 passing offline tests + positive OOS Sharpe** (technical credibility) ✓
