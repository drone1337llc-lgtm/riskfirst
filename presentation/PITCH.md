...
- **Fully offline-tested** against a deterministic mock client — **93 passing tests** (Greeks, parity, IV recovery, 2% sizing, drawdown blocks, spread/OI screens, MCP contract, LLM referee, paper-loop runner). Zero keys needed.
...
- **93 passing offline tests + positive OOS Sharpe** (technical credibility) ✓
